...
ENSM 메인 서버(ensm-main)의 로그 파일이 저장될 경로를 지정하는 설정입니다. 메인 서버의 모든 로그가 이 경로에 기록됩니다.
...
```
/var/log/main/main-app.log
```

## 주요 특징

- **절대 경로**: 전체 경로를 지정해야 합니다
- **로그 파일**: 메인 서버의 모든 로그가 이 파일에 기록됩니다
...
```
/var/log/main/main-app.log
/var/log/ensm/main.log
/opt/ensm/logs/main.log
```
